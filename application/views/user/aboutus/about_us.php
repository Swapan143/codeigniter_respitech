                        ...
                        <div class="row align-items-center">
                            <div class="col-7">
                                <div class="ingredients-img">
                                    <img src="<?=base_url()?>webroot/user_panel/assets/img/images/about1.png" alt="">
                                    <div class="active-years">
                                        <h2 class="title">49+ <span>Years</span></h2>
                                    </div>
                                </div>
                            </div>
                            <div class="col-5">
                                <div class="ingredients-content-wrap">
                                    ...
                                    <div class="ingredients-fact">
                                        <ul>
                                            <li>
                                                <div class="icon"><img src="<?=base_url()?>webroot/user_panel/assets/img/icon/about1.png" alt=""></div>
                                                <div class="content">
                                                    <h4>128+</h4>
                                            ...
                                            <li>
                                                <div class="icon"><img src="<?=base_url()?>webroot/user_panel/assets/img/icon/ing_icon02.png" alt=""></div>
                                                <div class="content">
                                                    <h4>35k+</h4>
                    ...
                    <div class="container-inner-wrap">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-10">
                                <div class="services-item">
                                    <a href="contact.html" class="services-link"></a>
                                    <div class="icon"><i class="fa-solid fa-bahai"></i></div>
                                    <div class="content">
                                        <h5>Automation</h5>
                                        <p>Knowledge base that organized collection system</p>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="newsletter-wrap">
                                    ...
                                    <img src="<?=base_url()?>webroot/user_panel/assets/img/images/newsletter_shape01.png" alt="" class="newsletter-shape top-shape wow fadeInDownBig" data-wow-delay=".3s">
                                    <img src="<?=base_url()?>webroot/user_panel/assets/img/images/newsletter_shape02.png" alt="" class="newsletter-shape bottom-shape wow fadeInUpBig" data-wow-delay=".3s">
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="support-info-item">
                                                    ...
                                                    <h2><i class="fa-solid fa-clock"></i> 24/7</h2>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="support-info-item">
                                                    <p>customer happiness rating</p>
                                                    <h2><i class="fa-solid fa-face-smile"></i> 98.9%</h2>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
