...
$category=$this->db->get('tbl_category')->result();
                                            foreach($category as $valsub) {
                                                ...
                                                $category_name=$valsub->category_name;
                        ...
                        <div class="breadcrumb-content">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?=base_url('category/'.$cate_string.'?cid='.$valsub->uniqcode)?>">Category Prodct</a></li>
                    ...
                    <div class="col-lg-5">
                        <div class="shop-details-content">
                            ...
                            <div class="shop-details-meta">
                                <ul>
                                    <li>Baands : <a href="shop.html"><?php echo $value->brand_name;?></a></li>
                        ...
                        <div class="product-desc-wrap">
                            ...
                            <div class="tab-content" id="myTabContentTwo">
                                <div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab">
                                    <div class="product-desc-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <!-- <span class="display-5 mb-0" data-toggle="counter-up">50</span> -->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="review" role="tabpanel" aria-labelledby="review-tab">
                                    <div class="product-desc-content">
                                        <h4 class="title">Product Review</h4>
                                        <div class="row">
                                            <div class="col-xl-3 col-md-5">
                                                <div class="product-desc-img">
                                                    <img src="<?=base_url('webroot/adminImages/product/web/'.$img.'')?>" alt="">
                                            ...
                                            <div class="col-xl-9 col-md-7">
                                              <div class="row rating-review-bar">
                                                  <div class="side">
                                                    <div>5 star</div>
                                                  </div>
                                                  <div class="middle">
                        ...
                        <div class="col-3">
                            <div class="sp-product-item mb-20">
                                <div class="sp-product-thumb">
                                    ...
                                    <a href="<?=base_url('category-product/details/'.$product_string.'?proid='.$valproduct->uniqcode.'&slug='.$valproduct->slug.'&cid='.$valproduct->category_id)?>"><img src="<?=base_url('webroot/adminImages/product/web/'.$img.'')?>" alt=""></a>
                                </div>
                                <div class="sp-product-content">
                                    <div class="rating">
                                        <i class="fas fa-star"></i>
                                 ...
                                 if($product_length>15){?> 
                                    <h6 class="title"><a href="<?=base_url('category-product/details/'.$product_string.'?proid='.$valproduct->uniqcode.'&slug='.$valproduct->slug.'&cid='.$valproduct->category_id)?>"><?php echo substr($valproduct->product_name,0,15).' '.'.....';?></a></h6>
                                    <?php } else {?> 
                                        <h6 class="title"><a href="<?=base_url('category-product/details/'.$product_string.'?proid='.$valproduct->uniqcode.'&slug='.$valproduct->slug.'&cid='.$valproduct->category_id)?>"><?php echo $valproduct->product_name;?></a></h6>
                                    <?php }?>
