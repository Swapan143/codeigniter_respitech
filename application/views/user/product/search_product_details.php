                        ...
                        <div class="col-3">
                            <div class="sp-product-item mb-20">
                                <div class="sp-product-thumb">
                                    ...
                                    <a href="<?=base_url('search-product/details/'.$product_string.'?proid='.$valproduct->uniqcode.'&slug='.$valproduct->slug.'&cid='.$valproduct->category_id)?>"><img src="<?=base_url('webroot/adminImages/product/web/'.$img.'')?>" alt=""></a>
                                </div>
                                <div class="sp-product-content">
                                    <div class="rating">
                                        <i class="fas fa-star"></i>
                                 ...
                                 if($product_length>15){?> 
                                    <h6 class="title"><a href="<?=base_url('search-product/details/'.$product_string.'?proid='.$valproduct->uniqcode.'&slug='.$valproduct->slug.'&cid='.$valproduct->category_id)?>"><?php echo substr($valproduct->product_name,0,15).' '.'.....';?></a></h6>
                                    <?php } else {?> 
                                        <h6 class="title"><a href="<?=base_url('search-product/details/'.$product_string.'?proid='.$valproduct->uniqcode.'&slug='.$valproduct->slug.'&cid='.$valproduct->category_id)?>"><?php echo $valproduct->product_name;?></a></h6>
                                    <?php }?>
