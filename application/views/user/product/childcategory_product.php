                        ...
                        <div class="col-12">
                            <div class="breadcrumb-content">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="<a href="<?=base_url('home')?>">Home</a></li>
                    ...
                    <div class="row justify-content-center">
                        ...
                        $product_string = preg_replace('/[^A-Za-z0-9\-]/', '-', $product_name_re);
                                    ...
                                    <div class="col-xl-3 col-md-4 col-sm-6">
                                        <div class="sp-product-item">
                                            <div class="sp-product-thumb">
                                                ...
                                                <a href="<?=base_url('childcategory-product/details/'.$product_string.'?proid='.$valproduct->uniqcode.'&slug='.$valproduct->slug.'&ccid='.$valproduct->child_category_id)?>"><img src="<?=base_url('webroot/adminImages/product/web/'.$img.'')?>" alt=""></a>
                                            </div>
                                 ...
                                 if($product_length>15){?> 
                                                <h6 class="title"><a href="<?=base_url('childcategory-product/details/'.$product_string.'?proid='.$valproduct->uniqcode.'&slug='.$valproduct->slug.'&ccid='.$valproduct->child_category_id)?>"><?php echo substr($valproduct->product_name,0,15).' '.'.....';?></a></h6>
                                                <?php } else {?> 
                                                    <h6 class="title"><a href="<?=base_url('childcategory-product/details/'.$product_string.'?proid='.$valproduct->uniqcode.'&slug='.$valproduct->slug.'&ccid='.$valproduct->child_category_id)?>"><?php echo $valproduct->product_name;?></a></h6>
                                                <?php }?>
