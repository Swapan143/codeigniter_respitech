...
<?php 
$this->db->where('uniqcode', $value->child_category_id);
$category=$this->db->get('tbl_child_category')->result();
                                            foreach($category as $valsub) {


                                                $category_name=$valsub->child_category_name;
                        ...
                        <div class="breadcrumb-content">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?=base_url('childcategory/'.$cate_string.'?cid='.$valsub->uniqcode)?>">Childcategory Prodct</a></li>
                        ...
                        <!--<div class="col-3">
                            <div class="sp-product-item mb-20">
                                ...
                                <div class="sp-product-content">
                                    ...
                                    <?php
                                    $this->db->where('child_category_id', $value->child_category_id);
                                    $this->db->order_by('id', 'DESC');
                                    //$this->db->limit(8);
