                        ...
                        <div class="breadcrumb-content">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?=base_url('best-offer-product')?>">Best Offer Prodct</a></li>
                            ...
                            $product_feture_id=$this->db->get('tbl_product_features')->result();
                                ...
                                $product_stock_id=$this->db->get('tbl_total_stock')->result();
                                        foreach ($product_stock_id as $total_stock) {
                                           ...
                                           echo $product_quantity=$total_stock->quantity;
                ...
                <div class="row align-items-end mb-40">
                    ...
                    <div class="col-md-4 col-sm-3">
                        <div class="section-btn text-left text-md-right">
                            <a href="<?=base_url('best-offer-product')?>" class="btn">View All</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-3">
                            <div class="sp-product-item mb-20">
                                <div class="sp-product-thumb">
                                    ...
                                    <a href="<?=base_url('best-offer-product/details/'.$product_string.'?proid='.$valproduct->uniqcode.'&slug='.$valproduct->slug.'&cid='.$valproduct->category_id)?>"><img src="<?=base_url('webroot/adminImages/product/web/'.$img.'')?>" alt=""></a>
                                </div>
                                <div class="sp-product-content">
                                    <div class="rating">
                                        <i class="fas fa-star"></i>
                                 ...
                                 if($product_length>15){?> 
                                    <h6 class="title"><a href="<?=base_url('best-offer-product/details/'.$product_string.'?proid='.$valproduct->uniqcode.'&slug='.$valproduct->slug.'&cid='.$valproduct->category_id)?>"><?php echo substr($valproduct->product_name,0,15).' '.'.....';?></a></h6>
                                    <?php } else {?> 
                                        <h6 class="title"><a href="<?=base_url('best-offer-product/details/'.$product_string.'?proid='.$valproduct->uniqcode.'&slug='.$valproduct->slug.'&cid='.$valproduct->category_id)?>"><?php echo $valproduct->product_name;?></a></h6>
                                    <?php }?>
