...
$currentURL = current_url();
 $proid_id=$this->input->get('pro_search');
 $cid_id=$this->input->get('name');
 $cur=$currentURL.'?pro_search='.$proid_id.'&name='.$cid_id;
    ...
    <div class="container">
        <div class="breadcrumb-content text-center">
            <ul>
                ...
                <li class="active">Shop By <?php print_r($result1);?> </li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="row flex-row-reverse">
            <div class="col-lg-9">
                <div class="shop-top-bar">
                    <div class="select-shoing-wrap" style="width:100%">
                        <div class="col-lg-8">
                             <?php
                        $new_arival=$this->db->get('tbl_product')->result();
                        ?>
                        <p>Total Product    (<?php echo count($result);?>)</p>
