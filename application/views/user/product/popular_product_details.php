                        ...
                        <div class="breadcrumb-content">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?=base_url('special-product')?>">Special Prodct</a></li>
                    ...
                    <div class="col-lg-5">
                        <div class="shop-details-content">
                            ...
                            <div class="shop-details-meta">
                                <ul>
                                    <li>Brands : <a href="shop.html"><?php echo $value->brand_name;?></a></li>
                ...
                <div class="row align-items-end mb-40">
                    ...
                    <div class="col-md-4 col-sm-3">
                        <div class="section-btn text-left text-md-right">
                            <a href="<?=base_url('special-product')?>" class="btn">View All</a>
                        </div>
                    </div>
                </div>
                        ...
                        <!--<div class="col-3">
                            <div class="sp-product-item mb-20">
                                ...
                                <div class="sp-product-content">
                                    ...
                                    <?php
                                    $this->db->where('special_products', "Yes");
                                    $this->db->order_by('id', 'DESC');
                                    //$this->db->limit(8);
