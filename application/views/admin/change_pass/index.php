<!-- <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            <li>
                <a href="<?=base_url('venue/dashboard')?>">Home</a>
            </li>            
            <li class="active">
        ...
        <div class="row">
            ...
            <div id="add_data">
                ...
                <h2>Change Password</h2><br>                   
                    <form role="form" id="validation_data" action="<?=base_url('admin/changepassword')?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-6">
                                 <div class="form-group">
                                <label>Current Password</label>
                                <input type="password" name="current_password" id="current_password" class="form-control validate[required]" data-errormessage-value-missing="Current password is required" data-prompt-position="bottomLeft" placeholder="************" value="<?= $current_pass ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" id="password" class="form-control validate[required, minSize[8], maxSize[20]]"  maxlength="20" data-errormessage-value-missing="New password is required" data-prompt-position="bottomLeft" placeholder="Type new password">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" id="password-confirm" name="confrim_password" class="form-control validate[required, minSize[8], maxSize[20]]" data-errormessage-value-missing="Confirm new password is required" data-prompt-position="bottomLeft" placeholder="Type Confirm new password">
