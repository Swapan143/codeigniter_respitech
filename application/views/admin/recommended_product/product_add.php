                ...
                <div class="row">
                    <div id="edit_data">
                        ...
                        <form role="form" id="product_add" action="" method="post" enctype="multipart/form-data">
                            <input type="hidden" id="recommended_id" name="recommended_id" value="<?=$recommended_id;?>">
                        <div class="row">
                            <div class="col-lg-4">
...
<style type="text/css">        
    ...
    $('#product_add').submit(function(e)
    {
        e.preventDefault();
        var catgegory_id=$('#catgegory_id').val();
        var recommended_id=$('#recommended_id').val();
       ...
       var formData = new FormData($(this)[0]);
        $.ajax({
            url:base_url+'admin/save-recommended-product',
            type: 'POST',
            data: formData,
            async: false,
            cache: false,
