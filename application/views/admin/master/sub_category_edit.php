            ...
            <div class="ibox-content">
                <div class="row">
                    <div id="edit_data">
                        ...
                        <form role="form" id="form" action="<?=base_url('admin/sub_update_category')?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                        <input type="hidden" value="<?=$sub_category_data->id?>" name="transid">
                                    ...
                                    <label>Category Name<span class="desc_text" style="color: red;">*</span></label>
                                        <select name="category_id" id="category_id" class="form-control">
                                            ...
                                            foreach ($category_data as $value) {
                                                if($value->id == $sub_category_data->category_id ){
                                              ?>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subcategory_name" id="subcategory_name" value="<?=$sub_category_data->subcategory_name?>" class="form-control validate[required]" data-errormessage-value-missing="Category Name is required" data-prompt-position="bottomLeft" maxlength="200">
                                    <p id="msg_category" style="display: none;" class="text-danger">Enter SubCategory Name</p>
                                </div>
                            </div>
