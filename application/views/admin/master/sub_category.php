                ...
                <div class="row">
                    <div id="edit_data">
                        ...
                        <div class="alert alert-success alert-dismissible fade in" id="emp_sucess" style="display: none;">
                            ...
                            <strong>Success!</strong> Sub Category Add.
                        </div>
                        ...
                        <form role="form" id="subcategory_add" action="" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Sub Category<span class="desc_text" style="color: red;">*</span></label>
                                    <input type="text" name="subcategory_name" id="subcategory_name" class="form-control" placeholder="Enter Sub Category" maxlength="10">
                                    <p id="msg_sub_category" style="display: none;" class="text-danger">Enter Sub Category</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="ibox-content">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover dataTables-example" >
                    ...
                    <tbody>
                    <?php foreach ($subcategory_data as $key => $value) {
                        
                        $this->db->where('id', $value->category_id);
                        $category_data1=$this->db->get('tbl_category')->row();
                                    
                    ?>
                        <tr class="gradeX">
                            <td><?=$key+1?></td>
                            <td><?=$category_data1->category_name?></td>
                            <td><?=$value->subcategory_name?></td>
                            <td>
                                <a href="<?=base_url('admin/sub-category/edit_data/'.$value->id)?>" id="get_action_val_<?=$value->id?>"><i class="fa fa-pencil-square action"></i></a>
                                <a href="<?=base_url('admin/sub-category/destroy/'.$value->id)?>" onclick="return confirm('Are you sure delete this Sub category?')"><i class="fa fa-trash action"></i></a>
                            </td>
...
<style type="text/css">        
    ...
    <script>
        ...
        $('#subcategory_add').submit(function(e){
        e.preventDefault();
       ...
       if(category_id =='Select Category Name')
          {
          ...
          if(subcategory_name =='')
          {
            ...
            $("#msg_sub_category").show();
        
            setTimeout(function() {
                   $("#msg_sub_category").hide();
                }, 1000); 
    ...
    //   alert(base_url);
       var formData = new FormData($(this)[0]);
        $.ajax({
            url:base_url+'subcategory_data_add',
            type: 'POST',
            data: formData,
            async: false,
            cache: false,
