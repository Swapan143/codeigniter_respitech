        			...
        			<h4>All Vendor</h4>    
 						...
 						<div class="ibox-content">
    						<div class="table-responsive">
        					  <form id="search_member_id" name="search_member_id" method="post"> 
                                 <label id="ci">
                                  <label id="c-a">
                                    Buyer Code&nbsp;&nbsp;&nbsp;&nbsp;
                                    </label>
                                    <label id="c-b">
                                            <input type="text" name="buyer_id" id="buyer_id"  aria-describedby="emailHelp" autocomplete="off"  onkeyup="buyer_code_serch(this.value)"; required>&nbsp;&nbsp;&nbsp;&nbsp;
                                             
                                             <input type="hidden" class="form-control" id="code_id" aria-describedby="emailHelp" name="code_id">
                                                    <ul id="d_search" class="search-dropdown inpu_dp" style="display: none;">
                                                      <!--<li>Xxxxxxxxxxx</li>
                                                      <!--<li>Xxxxxxxxxxx</li>-->
                                                      <!--<li>Xxxxxxxxxxx</li>-->
                                                    </ul>
                                     ...
                                     <label id="c-s">
                                    <button type="button" class="btn btn-primary" onclick="buyer_stock_serch();">Search</button>
                                  </label>
                                </label>   
                             </form>
    						    <br><br>
                    			...
                    			<tbody>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td><a href="<?=base_url('admin/vendor-product-view/'.$value->buyer_id)?>" target="_blank">View List</a></td>
                                    </tr>
                                    <?php
