                ...
                <div class="row">
                    <div id="edit_data">
                        ...
                        <div class="alert alert-danger alert-dismissible" style="display:none" id="mobile_exists_msg">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <strong>Faild!</strong> City Name Already Exists.
                        </div>
                        <form role="form" id="form" action="<?=base_url('admin/update-city')?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                        <input type="hidden" value="<?=$sub_category_data->id?>" name="transid">
                                    ...
                                    <label>State Name<span class="desc_text" style="color: red;">*</span></label>
                                        <select name="state_id" id="state_id" class="form-control">
                                            ...
                                            foreach ($category_data as $value) {
                                                if($value->id == $sub_category_data->state_id ){
                                              ?>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>City Name<span class="desc_text" style="color: red;">*</span></label>
                                    <input type="text" name="name" id="name" value="<?=$sub_category_data->name?>" class="form-control validate[required]" data-errormessage-value-missing="City Name is required" data-prompt-position="bottomLeft" maxlength="200">
                                    <p id="msg_category" style="display: none;" class="text-danger">Enter City Name</p>
                                </div>
                            </div>
