...
<body> <?php $segments = explode('/', trim(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH), '/'));
        ...
        <div class="container">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <footer>
                    <div class="footer-left-text" style="color: white;"> Copyright Respitech (©) 2020-<?=date('Y')?></div>
                    <div class="footer-right-text" style="color: white;">Design &amp; Developed by <a href="https://respitech.co.in//" target="_blank"><strong>Respitech</strong></a>
                    </div>
                </footer>
                </div>
            </div>
